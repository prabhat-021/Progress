...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between text-sm  mb-5 border-b border-b-[#ADADAD]">
      {/* <div className="fixed top-0 left-0 w-full z-50 bg-white flex items-center justify-between text-sm py-3 px-5 border-b border-b-[#ADADAD]"> */}
      ...
      <div className="flex items-center gap-4 ">
        ...
        <div className={`md:hidden ${showMenu ? "fixed w-full" : "h-0 w-0"} right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
          ...
          <ul className="flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium">
            ...
            <NavLink onClick={() => setShowMenu(false)} to="/College" ><p className="px-4 py-2 rounded full inline-block">ALL COLLEGES</p></NavLink>
