...
<div className='min-w-[250px] max-w-[300px] shadow-2xl p-10 rounded-2xl bg-stone-600'>

<RiGraduationCapLine size={"80px"} />
    <div className='text-2xl text-my-blue font-bold mt-5'>B.tech</div>
    <div className='text-my-grey mt-3'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quas, eaque. Lorem ipsum
    </div>
    
    <div className='text-xl text-my-orange font-bold mt-5'>Read More</div>
</div>
<div className='min-w-[250px] max-w-[300px] shadow-2xl p-10 rounded-2xl bg-stone-600'>
<RiGraduationCapLine size={"80px"} />
    <div className='text-2xl text-my-blue font-bold mt-5'>M.tech</div>
    <div className='text-my-grey mt-3'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quas, eaque. Lorem ipsum </div>
    <div className='text-xl text-my-orange font-bold mt-5'>Read More</div>
</div>
<div className='min-w-[250px] max-w-[300px]  shadow-2xl p-10 rounded-2xl bg-stone-600'>
<RiGraduationCapLine size={"80px"} />
    ...
    <div className='text-xl text-my-orange font-bold mt-5'>Read More</div>
      ...
      <div className=' flex justify-center text-my-grey text-white text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque, ipsum!</div>


      <div className='flex gap-5 m-10 flex-wrap justify-center'>
        {food_data.map((e)=><Card_1 name={e.name} imglink={e.img} price={e.price} key={e}/>)}
      </div>
      </div>
