    ...
    <>
      ...
      <div className="relative mx-auto w-full max-w-7xl bg-[#e4e6e6] text-gray-700">
        <div className="grid grid-cols-2">
          {/* :MAP CONTAINER */}
          <div className="order-1 col-span-full p-12">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1470.672368835693!2d77.49754313619725!3d28.753355125006895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cf574d18f2b6f%3A0x4a65c0bc0122eb2f!2sKIET%20Group%20of%20Institutions!5e0!3m2!1sen!2sin!4v1714596795033!5m2!1sen!2sin"
              title="map"
              scrolling="no"
              frameborder="0"
              width="100%"
          ...
          <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
            <div className="mx-auto max-w-xl flex flex-col space-y-5">
              ...
              <a
                href="#mail"
                className="inline-flex items-center text-sm text-blue-700 hover:text-blue-800  font-semibold"
              >
                {/* <MailIcon className="mr-2 w-5 text-gray-400" /> */}
                Email: director@kiet.edu <br /> jointdirector@kiet.edu <br />
                registrar@kiet.edu
              </a>
              {/* ::Address */}
              <p className="text-sm text-gray-500 leading-6">
                Delhi-NCR, Ghaziabad-Meerut Road <br /> 201206 Paris <br />{" "}
                Ghaziabad
              </p>
              {/* ::Socials */}
