...
const { resetPassword, registerUser, authUser, verifyEmail, forgetPassword , redisData} = require("../controllers/userControllers.js");
...
router.route("/redis-data").get(redisData);
